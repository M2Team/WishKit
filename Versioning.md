...
This document applies to all versions of WishKit.
...
The build number is the number of days since April 24, 2024 because the first 
version of WishKit is created and published on that day.
